Перед стартом работы над проектом следует ознакомится с [Руководством по стилю GDScript](https://docs.godotengine.org/ru/stable/tutorials/scripting/gdscript/gdscript_styleguide.html)
